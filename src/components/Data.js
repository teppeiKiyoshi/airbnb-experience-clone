...
import sportImg from '../images/mountain-bike.png';
import weddingImg from '../images/wedding-photography.png';
import hunterImg from '../images/hisoka.jpg';
...
export default [
  ...
  {
    id: 4,
    title: 'Hunter Creek Hike',
    description:
      'Hike the Hunter Creek Trail in the beautiful Northern Sierra Nevada. (Hike provided!)',
    price: 250,
    coverImg: hunterImg,
    stats: {
      rating: 4.9,
